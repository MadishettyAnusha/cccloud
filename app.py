...
# currentlocation = os.path.dirname(os.path.abspath(_file_))
...
config = {
    'host':'database25.mysql.database.azure.com', 
    'user':'madishaa@database25',
    'password':'iforgot1234567A$',
    'database':'mydb',
    'port': 3306
    ...
    if request.method == 'POST':
        ...
        if hdata.filename == '' or tdata.filename == '' or pdata.filename == '':
            ...
            col_names = ['HSHD_NUM', 'L', 'AGE_RANGE', 'MARITAL', 'INCOME_RANGE',
                         'HOMEO WNER', 'HSHD_COMPOSITION', 'HH_SIZE', 'CHILDREN']
